...
public class CodeDaoImpl implements CodeDao {
    ...
    private Connection getConnection(DbconfigInfo dbconfigInfo) {
        ...
        try {
            Class.forName(dbconfigInfo.getDriver());// 加载Mysql数据驱动
            con = DriverManager.getConnection(dbconfigInfo.getUrl(), dbconfigInfo.getUsername(), dbconfigInfo.getPassword());// 创建数据连接
